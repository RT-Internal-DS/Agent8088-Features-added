...
export function StatusBar() {
  ...
  return (
    <div className="flex h-7 items-center gap-3 border-t border-zinc-200 dark:border-zinc-800/60 light:border-zinc-200 bg-zinc-950 dark:bg-zinc-950 light:bg-white px-3 text-[11px] text-zinc-500 dark:text-zinc-500 light:text-zinc-400">
      <span className="flex items-center gap-1.5">
        <span className={cn('h-1.5 w-1.5 rounded-full', isStreaming ? 'animate-pulse bg-brand-cyan' : 'bg-zinc-400')} />
        {isStreaming ? 'running' : 'ready'}
      </span>
      <span className="text-zinc-300 dark:text-zinc-700 light:text-zinc-300">·</span>
